...
const es: Record<string, string> = {
  ...
  "txt_webauthn": "Claves de seguridad (WebAuthn / FIDO2)",
  "txt_webauthn_keys": "Claves de seguridad registradas",
  "txt_webauthn_no_keys": "No hay claves de seguridad registradas.",
  "txt_webauthn_add_key": "Añadir clave de seguridad",
  "txt_webauthn_key_name": "Nombre de la clave (opcional)",
  "txt_webauthn_key_name_placeholder": "p. ej. YubiKey 5, Touch ID de MacBook",
  "txt_webauthn_default_key_name": "Clave de seguridad",
  "txt_webauthn_registering": "Toque o active su clave de seguridad…",
  "txt_webauthn_register_failed": "Error al registrar la clave de seguridad",
  "txt_webauthn_register_success": "Clave de seguridad registrada",
  "txt_webauthn_create_cancelled": "Operación de clave de seguridad cancelada",
  "txt_webauthn_create_failed": "Error al activar la clave de seguridad",
  "txt_webauthn_get_cancelled": "Operación de clave de seguridad cancelada",
  "txt_webauthn_assertion_failed": "Error de autenticación con clave de seguridad",
  "txt_webauthn_load_failed": "Error al cargar la configuración de clave de seguridad",
  "txt_webauthn_challenge_failed": "Error al obtener el desafío de clave de seguridad",
  "txt_webauthn_delete_key": "Eliminar clave",
  "txt_webauthn_delete_key_confirm_title": "Eliminar clave de seguridad",
  "txt_webauthn_delete_key_confirm_msg": "¿Eliminar la clave de seguridad \"{name}\"? Podría perder el acceso si este es su único método de 2FA.",
  "txt_webauthn_delete_failed": "Error al eliminar la clave de seguridad",
  "txt_webauthn_delete_success": "Clave de seguridad eliminada",
  "txt_webauthn_disable_all_success": "Claves de seguridad deshabilitadas",
  ...
  "txt_reenable_totp_msg": "Ingresa tu contraseña maestra y un código actual de tu app de autenticación para volver a habilitar TOTP.",
  "txt_reenable_totp_code": "Código del autenticador",
  "txt_reenable_totp_code_placeholder": "Código de 6 dígitos",
  ...
  "txt_reenable_webauthn_msg": "Confirma tu contraseña maestra y luego completa la solicitud con tu llave de seguridad para volver a habilitarla.",
  "txt_reenable_webauthn_prompt": "Después de confirmar, usa tu llave de acceso o llave de seguridad para completar la verificación.",
  "txt_reenable_webauthn_verifying": "Esperando la llave de seguridad…",
  ...
  "txt_reenable_email_mfa_msg": "Ingresa tu contraseña maestra y enviaremos un código de verificación a tu correo registrado.",
  "txt_reenable_email_mfa_verify_msg": "Ingresa el código de verificación que te enviamos por correo para volver a habilitar la autenticación de dos factores por correo.",
  "txt_reenable_email_send_code": "Enviar código de verificación",
  "txt_reenable_email_code_sent_generic": "Se envió un código de verificación a tu correo registrado.",
  ...
  "txt_email_mfa_load_failed": "Error al cargar el estado de verificación por correo",
  "txt_email_otp_send_failed": "Error al enviar el código de verificación por correo",
  "txt_email_otp_verify_failed": "El código de verificación es incorrecto o ha caducado",
  "txt_email_otp_code": "Código de verificación por correo",
  "txt_email_otp_resend": "Reenviar código",
  "txt_email_otp_sent_to": "Se envió un código de verificación a {email}",
  "txt_use_email_code": "Usar código de correo",
  "txt_email_mfa_setup_email": "Dirección de correo electrónico",
  "txt_email_mfa_setup_master_password": "Contraseña maestra",
  "txt_email_mfa_send_code": "Enviar código de verificación",
  "txt_email_mfa_verify_and_enable": "Verificar y habilitar",
  "txt_email_mfa_setup_title": "Configurar verificación por correo",
  "txt_email_mfa_setup_step1": "Ingresa la dirección de correo para recibir los códigos y confirma con tu contraseña maestra.",
  "txt_email_mfa_setup_step2": "Ingresa el código de verificación enviado a {email}.",
  "txt_email_mfa_setup_sending": "Enviando…",
  "txt_email_mfa_setup_verifying": "Verificando…",
  "txt_email_mfa_setup_success": "Verificación de dos pasos por correo habilitada",
  "txt_email_mfa_setup_send_failed": "Error al enviar el código de configuración",
  "txt_email_mfa_setup_verify_failed": "Error al verificar el código",
  "txt_use_totp_instead": "Usar aplicación de autenticación"
};
