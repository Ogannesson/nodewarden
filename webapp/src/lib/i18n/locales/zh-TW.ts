...
const zhTW: Record<string, string> = {
  ...
  "txt_webauthn": "安全金鑰（WebAuthn / FIDO2）",
  "txt_webauthn_keys": "已登錄的安全金鑰",
  "txt_webauthn_no_keys": "尚未登錄安全金鑰。",
  "txt_webauthn_add_key": "新增安全金鑰",
  "txt_webauthn_key_name": "金鑰名稱（選填）",
  "txt_webauthn_key_name_placeholder": "例如：YubiKey 5、MacBook Touch ID",
  "txt_webauthn_default_key_name": "安全金鑰",
  "txt_webauthn_registering": "請觸碰或啟用您的安全金鑰…",
  "txt_webauthn_register_failed": "安全金鑰登錄失敗",
  "txt_webauthn_register_success": "安全金鑰登錄成功",
  "txt_webauthn_create_cancelled": "安全金鑰操作已取消",
  "txt_webauthn_create_failed": "安全金鑰啟用失敗",
  "txt_webauthn_get_cancelled": "安全金鑰操作已取消",
  "txt_webauthn_assertion_failed": "安全金鑰驗證失敗",
  "txt_webauthn_load_failed": "載入安全金鑰設定失敗",
  "txt_webauthn_challenge_failed": "取得安全金鑰挑戰失敗",
  "txt_webauthn_delete_key": "移除金鑰",
  "txt_webauthn_delete_key_confirm_title": "移除安全金鑰",
  "txt_webauthn_delete_key_confirm_msg": "移除安全金鑰「{name}」？若這是您唯一的兩步驟驗證方式，移除後可能無法登入。",
  "txt_webauthn_delete_failed": "移除安全金鑰失敗",
  "txt_webauthn_delete_success": "安全金鑰已移除",
  "txt_webauthn_disable_all_success": "安全金鑰已停用",
  ...
  "txt_reenable_totp_msg": "請輸入主密碼並填寫驗證器 App 中的目前驗證碼，以重新啟用 TOTP。",
  "txt_reenable_totp_code": "驗證器驗證碼",
  "txt_reenable_totp_code_placeholder": "6 位數驗證碼",
  ...
  "txt_reenable_webauthn_msg": "請先確認主密碼，然後使用安全金鑰完成驗證以重新啟用。",
  "txt_reenable_webauthn_prompt": "確認後，請使用你的通行金鑰或安全金鑰完成驗證。",
  "txt_reenable_webauthn_verifying": "等待安全金鑰…",
  "txt_email_mfa_reenabled": "電子郵件驗證已重新啟用",
  "txt_reenable_email_mfa_failed": "重新啟用電子郵件驗證失敗",
  "txt_reenable_email_mfa": "重新啟用電子郵件驗證",
  "txt_reenable_email_mfa_msg": "請輸入主密碼，我們將向你的已註冊電子郵件發送驗證碼。",
  "txt_reenable_email_mfa_verify_msg": "請輸入我們發送到你電子郵件的驗證碼，以重新啟用電子郵件兩步驗證。",
  "txt_reenable_email_send_code": "發送驗證碼",
  "txt_reenable_email_code_sent_generic": "驗證碼已發送至你的已註冊電子郵件。",
  "txt_email_mfa_configured_but_disabled": "電子郵件兩步驗證已設定但目前已停用，點擊開關可重新啟用。",
  "txt_email_mfa_load_failed": "載入電子郵件兩步驗證狀態失敗",
  "txt_email_otp_send_failed": "發送電子郵件驗證碼失敗",
  "txt_email_otp_verify_failed": "電子郵件驗證碼不正確或已過期",
  "txt_email_otp_code": "電子郵件驗證碼",
  "txt_email_otp_resend": "重新發送",
  "txt_email_otp_sent_to": "驗證碼已發送至 {email}",
  "txt_use_email_code": "使用電子郵件驗證碼",
  "txt_email_mfa_setup_email": "電子郵件地址",
  "txt_email_mfa_setup_master_password": "主密碼",
  "txt_email_mfa_send_code": "發送驗證碼",
  "txt_email_mfa_verify_and_enable": "驗證並啟用",
  "txt_email_mfa_setup_title": "設定電子郵件驗證",
  "txt_email_mfa_setup_step1": "請輸入用於接收驗證碼的電子郵件地址，並以主密碼確認。",
  "txt_email_mfa_setup_step2": "請輸入發送到 {email} 的驗證碼。",
  "txt_email_mfa_setup_sending": "發送中…",
  "txt_email_mfa_setup_verifying": "驗證中…",
  "txt_email_mfa_setup_success": "電子郵件兩步驗證已啟用",
  "txt_email_mfa_setup_send_failed": "發送設定驗證碼失敗",
  "txt_email_mfa_setup_verify_failed": "驗證碼驗證失敗",
  "txt_use_totp_instead": "使用驗證器應用程式"
};
