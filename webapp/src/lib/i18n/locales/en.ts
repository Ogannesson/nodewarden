...
const en: Record<string, string> = {
  ...
  "txt_recovery_code_view_rotates_warning": "Viewing your recovery code generates a brand-new code. The previous code stops working immediately, so store the new one safely.",
  "txt_api_key": "API Key",
  ...
  "txt_webauthn": "Security Keys (WebAuthn / FIDO2)",
  "txt_webauthn_keys": "Registered Security Keys",
  "txt_webauthn_no_keys": "No security keys registered.",
  "txt_webauthn_add_key": "Add Security Key",
  "txt_webauthn_key_name": "Key name (optional)",
  "txt_webauthn_key_name_placeholder": "e.g. YubiKey 5, MacBook Touch ID",
  "txt_webauthn_default_key_name": "Security Key",
  "txt_webauthn_registering": "Touch / activate your security key…",
  "txt_webauthn_register_failed": "Security key registration failed",
  "txt_webauthn_register_success": "Security key registered",
  "txt_webauthn_create_cancelled": "Security key operation cancelled",
  "txt_webauthn_create_failed": "Security key activation failed",
  "txt_webauthn_get_cancelled": "Security key operation cancelled",
  "txt_webauthn_assertion_failed": "Security key authentication failed",
  "txt_webauthn_load_failed": "Failed to load security key settings",
  "txt_webauthn_challenge_failed": "Failed to get security key challenge",
  "txt_webauthn_delete_key": "Remove Key",
  "txt_webauthn_delete_key_confirm_title": "Remove Security Key",
  "txt_webauthn_delete_key_confirm_msg": "Remove security key \"{name}\"? You may be locked out if this is your only 2FA method.",
  "txt_webauthn_delete_failed": "Failed to remove security key",
  "txt_webauthn_delete_success": "Security key removed",
  "txt_webauthn_disable_all_success": "Security keys disabled",
  ...
  "txt_reenable_totp_msg": "Enter your master password and a current code from your authenticator app to re-enable TOTP.",
  "txt_reenable_totp_code": "Authenticator code",
  "txt_reenable_totp_code_placeholder": "6-digit code",
  ...
  "txt_reenable_webauthn_msg": "Confirm your master password, then complete the prompt with your security key to re-enable it.",
  "txt_reenable_webauthn_prompt": "After confirming, use your passkey or security key to complete verification.",
  "txt_reenable_webauthn_verifying": "Waiting for security key…",
  ...
  "txt_reenable_email_mfa_msg": "Enter your master password and we'll email a verification code to your enrolled address.",
  "txt_reenable_email_mfa_verify_msg": "Enter the verification code we emailed you to re-enable email two-factor authentication.",
  "txt_reenable_email_send_code": "Send Verification Code",
  "txt_reenable_email_code_sent_generic": "A verification code was sent to your enrolled email address.",
  "txt_email_mfa_configured_but_disabled": "Email 2FA is configured but currently disabled. Toggle to re-enable.",
  "txt_email_mfa_load_failed": "Failed to load email 2FA status",
  "txt_email_otp_send_failed": "Failed to send email verification code",
  "txt_email_otp_verify_failed": "Email verification code incorrect or expired",
  "txt_email_otp_code": "Email Verification Code",
  "txt_email_otp_resend": "Resend Code",
  "txt_email_otp_sent_to": "A verification code was sent to {email}",
  "txt_use_email_code": "Use Email Code",
  "txt_email_mfa_setup_email": "Email address",
  "txt_email_mfa_setup_master_password": "Master password",
  "txt_email_mfa_send_code": "Send Verification Code",
  "txt_email_mfa_verify_and_enable": "Verify and Enable",
  "txt_email_mfa_setup_title": "Set Up Email Verification",
  "txt_email_mfa_setup_step1": "Enter the email address to receive codes and confirm with your master password.",
  "txt_email_mfa_setup_step2": "Enter the verification code sent to {email}.",
  "txt_email_mfa_setup_sending": "Sending…",
  "txt_email_mfa_setup_verifying": "Verifying…",
  "txt_email_mfa_setup_success": "Email two-step verification enabled",
  "txt_email_mfa_setup_send_failed": "Failed to send setup code",
  "txt_email_mfa_setup_verify_failed": "Failed to verify code",
  "txt_use_totp_instead": "Use Authenticator App"
};
