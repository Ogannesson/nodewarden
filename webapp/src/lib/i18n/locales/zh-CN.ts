...
const zhCN: Record<string, string> = {
  ...
  "txt_webauthn": "安全密钥（WebAuthn / FIDO2）",
  "txt_webauthn_keys": "已注册的安全密钥",
  "txt_webauthn_no_keys": "尚未注册安全密钥。",
  "txt_webauthn_add_key": "添加安全密钥",
  "txt_webauthn_key_name": "密钥名称（可选）",
  "txt_webauthn_key_name_placeholder": "例如：YubiKey 5、MacBook Touch ID",
  "txt_webauthn_default_key_name": "安全密钥",
  "txt_webauthn_registering": "请触碰或激活您的安全密钥…",
  "txt_webauthn_register_failed": "安全密钥注册失败",
  "txt_webauthn_register_success": "安全密钥注册成功",
  "txt_webauthn_create_cancelled": "安全密钥操作已取消",
  "txt_webauthn_create_failed": "安全密钥激活失败",
  "txt_webauthn_get_cancelled": "安全密钥操作已取消",
  "txt_webauthn_assertion_failed": "安全密钥认证失败",
  "txt_webauthn_load_failed": "加载安全密钥设置失败",
  "txt_webauthn_challenge_failed": "获取安全密钥挑战失败",
  "txt_webauthn_delete_key": "移除密钥",
  "txt_webauthn_delete_key_confirm_title": "移除安全密钥",
  "txt_webauthn_delete_key_confirm_msg": "移除安全密钥「{name}」？若这是您唯一的两步验证方式，移除后可能无法登录。",
  "txt_webauthn_delete_failed": "移除安全密钥失败",
  "txt_webauthn_delete_success": "安全密钥已移除",
  "txt_webauthn_disable_all_success": "安全密钥已禁用",
  ...
  "txt_reenable_totp_msg": "请输入主密码并填写验证器 App 中的当前验证码，以重新启用 TOTP。",
  "txt_reenable_totp_code": "验证器验证码",
  "txt_reenable_totp_code_placeholder": "6 位验证码",
  ...
  "txt_reenable_webauthn_msg": "请先确认主密码，然后使用安全密钥完成验证以重新启用。",
  "txt_reenable_webauthn_prompt": "确认后，请使用你的通行密钥或安全密钥完成验证。",
  "txt_reenable_webauthn_verifying": "等待安全密钥…",
  "txt_email_mfa_reenabled": "邮件验证已重新启用",
  "txt_reenable_email_mfa_failed": "重新启用邮件验证失败",
  "txt_reenable_email_mfa": "重新启用邮件验证",
  "txt_reenable_email_mfa_msg": "请输入主密码，我们将向你的已注册邮箱发送验证码。",
  "txt_reenable_email_mfa_verify_msg": "请输入我们发送到你邮箱的验证码，以重新启用邮件两步验证。",
  "txt_reenable_email_send_code": "发送验证码",
  "txt_reenable_email_code_sent_generic": "验证码已发送至你的已注册邮箱。",
  "txt_email_mfa_configured_but_disabled": "邮件两步验证已配置但当前已禁用，点击开关可重新启用。",
  "txt_email_mfa_load_failed": "加载邮件两步验证状态失败",
  "txt_email_otp_send_failed": "发送邮件验证码失败",
  "txt_email_otp_verify_failed": "邮件验证码不正确或已过期",
  "txt_email_otp_code": "邮件验证码",
  "txt_email_otp_resend": "重新发送",
  "txt_email_otp_sent_to": "验证码已发送至 {email}",
  "txt_use_email_code": "使用邮件验证码",
  "txt_email_mfa_setup_email": "邮箱地址",
  "txt_email_mfa_setup_master_password": "主密码",
  "txt_email_mfa_send_code": "发送验证码",
  "txt_email_mfa_verify_and_enable": "验证并启用",
  "txt_email_mfa_setup_title": "设置邮件验证",
  "txt_email_mfa_setup_step1": "请输入用于接收验证码的邮箱地址并用主密码确认。",
  "txt_email_mfa_setup_step2": "请输入发送到 {email} 的验证码。",
  "txt_email_mfa_setup_sending": "发送中…",
  "txt_email_mfa_setup_verifying": "验证中…",
  "txt_email_mfa_setup_success": "邮件两步验证已启用",
  "txt_email_mfa_setup_send_failed": "发送设置验证码失败",
  "txt_email_mfa_setup_verify_failed": "验证码验证失败",
  "txt_use_totp_instead": "使用验证器应用"
};
