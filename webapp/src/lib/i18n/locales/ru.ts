...
const ru: Record<string, string> = {
  ...
  "txt_webauthn": "Ключи безопасности (WebAuthn / FIDO2)",
  "txt_webauthn_keys": "Зарегистрированные ключи безопасности",
  "txt_webauthn_no_keys": "Нет зарегистрированных ключей безопасности.",
  "txt_webauthn_add_key": "Добавить ключ безопасности",
  "txt_webauthn_key_name": "Название ключа (необязательно)",
  "txt_webauthn_key_name_placeholder": "например YubiKey 5, Touch ID MacBook",
  "txt_webauthn_default_key_name": "Ключ безопасности",
  "txt_webauthn_registering": "Прикоснитесь или активируйте ваш ключ безопасности…",
  "txt_webauthn_register_failed": "Ошибка регистрации ключа безопасности",
  "txt_webauthn_register_success": "Ключ безопасности зарегистрирован",
  "txt_webauthn_create_cancelled": "Операция с ключом безопасности отменена",
  "txt_webauthn_create_failed": "Ошибка активации ключа безопасности",
  "txt_webauthn_get_cancelled": "Операция с ключом безопасности отменена",
  "txt_webauthn_assertion_failed": "Ошибка аутентификации с ключом безопасности",
  "txt_webauthn_load_failed": "Не удалось загрузить настройки ключа безопасности",
  "txt_webauthn_challenge_failed": "Не удалось получить вызов ключа безопасности",
  "txt_webauthn_delete_key": "Удалить ключ",
  "txt_webauthn_delete_key_confirm_title": "Удалить ключ безопасности",
  "txt_webauthn_delete_key_confirm_msg": "Удалить ключ безопасности «{name}»? Вы можете потерять доступ, если это единственный метод двухфакторной аутентификации.",
  "txt_webauthn_delete_failed": "Не удалось удалить ключ безопасности",
  "txt_webauthn_delete_success": "Ключ безопасности удалён",
  "txt_webauthn_disable_all_success": "Ключи безопасности отключены",
  ...
  "txt_reenable_totp_msg": "Введите мастер-пароль и текущий код из приложения-аутентификатора, чтобы повторно включить TOTP.",
  "txt_reenable_totp_code": "Код аутентификатора",
  "txt_reenable_totp_code_placeholder": "6-значный код",
  ...
  "txt_reenable_webauthn_msg": "Подтвердите мастер-пароль, затем завершите запрос с помощью ключа безопасности, чтобы включить его снова.",
  "txt_reenable_webauthn_prompt": "После подтверждения используйте passkey или ключ безопасности для завершения проверки.",
  "txt_reenable_webauthn_verifying": "Ожидание ключа безопасности…",
  ...
  "txt_reenable_email_mfa_msg": "Введите мастер-пароль, и мы отправим код подтверждения на ваш зарегистрированный email.",
  "txt_reenable_email_mfa_verify_msg": "Введите код подтверждения, отправленный на ваш email, чтобы повторно включить двухфакторную аутентификацию по email.",
  "txt_reenable_email_send_code": "Отправить код подтверждения",
  "txt_reenable_email_code_sent_generic": "Код подтверждения отправлен на ваш зарегистрированный email.",
  ...
  "txt_email_mfa_load_failed": "Не удалось загрузить статус аутентификации по email",
  "txt_email_otp_send_failed": "Не удалось отправить код подтверждения на email",
  "txt_email_otp_verify_failed": "Код подтверждения неверен или устарел",
  "txt_email_otp_code": "Код подтверждения email",
  "txt_email_otp_resend": "Отправить повторно",
  "txt_email_otp_sent_to": "Код подтверждения отправлен на {email}",
  "txt_use_email_code": "Использовать код email",
  "txt_email_mfa_setup_email": "Адрес электронной почты",
  "txt_email_mfa_setup_master_password": "Мастер-пароль",
  "txt_email_mfa_send_code": "Отправить код подтверждения",
  "txt_email_mfa_verify_and_enable": "Подтвердить и включить",
  "txt_email_mfa_setup_title": "Настройка аутентификации по email",
  "txt_email_mfa_setup_step1": "Введите email для получения кодов и подтвердите мастер-паролем.",
  "txt_email_mfa_setup_step2": "Введите код подтверждения, отправленный на {email}.",
  "txt_email_mfa_setup_sending": "Отправка…",
  "txt_email_mfa_setup_verifying": "Проверка…",
  "txt_email_mfa_setup_success": "Двухфакторная аутентификация по email включена",
  "txt_email_mfa_setup_send_failed": "Не удалось отправить код настройки",
  "txt_email_mfa_setup_verify_failed": "Не удалось проверить код",
  "txt_use_totp_instead": "Использовать приложение для аутентификации"
};
